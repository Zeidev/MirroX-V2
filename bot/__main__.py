...
from bot import bot, app, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, nox, OWNER_ID, AUTHORIZED_CHATS, FINISHED_PROGRESS_STR, UNFINISHED_PROGRESS_STR, telegraph_token
...
def stats(update, context):
    ...
    stats = f'<b>BOT UPTIME</b>: {currentTime}\n\n' \
            ...
            f'<b>FREQUENCY</b>: {freqcurrent} MHz\n\n' \
...
def start(update, context):
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        sendMessage("YOI", context.bot, update)
    else:
        sendMessage("Bhag", context.bot, update)
