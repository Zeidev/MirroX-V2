...
def cloneNode(update, context):
    ...
    if link is not None:
        ...
        if button in ["cancelled", ""]:
            ...
            logmsg = sendLog(result + cc + msc, context.bot, update, button)
            if logmsg:
                sendMarkup(result + fwdpm, context.bot, update, InlineKeyboardMarkup([[InlineKeyboardButton(text="CLICK HERE", url=logmsg.link)]]))
    else:
